package orizemanltd.com.foodies.ui.fragments.recipes
...
import orizemanltd.com.foodies.adapters.RecipesAdapter
import orizemanltd.com.foodies.util.NetworkResult
import orizemanltd.com.foodies.viewmodels.MainViewModel
import orizemanltd.com.foodies.viewmodels.RecipesViewModel
        ...
        mainViewModel.recipesResponse.observe(viewLifecycleOwner) { response ->
            when (response) {
                is NetworkResult.Success -> {
                    hideShimmerEffect()
                    response.data?.let { mAdapter.submitList(it.results) }
                }
